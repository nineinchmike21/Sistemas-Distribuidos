    ...
    public void enviaPedido(Pedido p) {
        try {
            ...
            if(resposta instanceof String){
                System.out.println("--- resp do tipo String");
            } else if (resposta instanceof Registo) {
                System.out.println("-- resp do tipo Registo");
            }
